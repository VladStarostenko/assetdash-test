...
export const assetsPage2 = [
  {
    ...
    imageUrl: 'https://storage.googleapis.com/iex/api/logos/GILD.png',
    currentPrice: 71.815,
  ...
  },
  {
    ...
    ticker: 'SBUX',
    name: 'Starbucks',
    imageUrl: 'https://storage.googleapis.com/iex/api/logos/SBUX.png',
    currentPrice: 76.11,
  ...
  },
  {
    ...
    ticker: 'BUD',
    name: 'Anheuser-Busch',
    imageUrl: 'https://storage.googleapis.com/iex/api/logos/BUD.png',
    currentPrice: 54.37,
